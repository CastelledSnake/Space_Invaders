 ...
 */
public class objet_jeux_1J extends objet_jeux {
    /**
     ...
     * @param vie
     */
    public objet_jeux_1J(double x, double y, double[] forme, Color color, String ImageURL, int vie) {
     ...
     * @return le joueur
     */
    public static objet_jeux init_Player(int nbvies, String URL) {
        return(new objet_jeux_1J(600, 590, formecanon, Color.LIMEGREEN, URL, nbvies));
    }
    ...
    public static void init_aliens(Group aliens, String URL) {
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 3; j++) {
                objet_jeux alien = new objet_jeux(10d + 50 * i, 10d + 35 * j, formalien, Color.LIMEGREEN, URL, 1);
    ...
    public static void init_blocks(Group blocks, Group vie_blocks) {
        for (int i = 0; i < 4; i++) {
            objet_jeux block = new objet_jeux(300 * i + 110d, 550, formebloc, Color.LIMEGREEN, "NULL", 10);
     ...
     */
    public static void dep_1_joueur(objet_jeux Player1, int dep1, int difficulté) {
