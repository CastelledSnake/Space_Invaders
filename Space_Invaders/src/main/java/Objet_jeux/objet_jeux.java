...
public class objet_jeux {
     ...
     */
    public objet_jeux(double x, double y, double[] forme, Color color, String ImageURL, int vie) {
    ...
    public static int tir_joueur(int n, int t, objet_jeux Player1, Group tirs_joueurs, String URL) {
        if (t == n) {
            objet_jeux tirj = new objet_jeux(Player1.representation.getLayoutX() + 25d, Player1.representation.getLayoutY(), formetir, Color.GREEN, URL, 1);
    ...
    public static void tir_alien(Group aliens, Group tirs_aliens, String URL, int proba) {
        if (proba>0) {
            if (objet_jeux.getRandomNumber(0, proba) == 0) {
                int a = objet_jeux.getRandomNumber(0, aliens.getChildren().size());
                objet_jeux tira = new objet_jeux(aliens.getChildren().get(a).getLayoutX(), aliens.getChildren().get(a).getLayoutY(), formetir, Color.RED, URL, 1);
     ...
     * @param ymax marge négative autorisée dans les ordonnées
     */
    public static void Collision_joueur(objet_jeux Player, Group tir, int xmin, int xmax, int ymin, int ymax) {
